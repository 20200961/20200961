...
- 🇰🇷 대한민국 기반의 웹 개발자
- 🎓 미디어소프트웨어학과 전공
- 💻 주로 **Spring Boot**를 사용해 개발합니다
- 🏗️ 안정적이고 확장 가능한 웹 서비스 구축에 관심이 있습니다
- 🧹 깔끔한 구조와 유지보수 가능한 코드를 중요하게 생각합니다

<!-- 이런 것들도 추가 가능: -->
- 🔥 **성능 최적화**와 **코드 리팩토링**에 관심이 많습니다
- 📚 새로운 기술을 배우고 적용하는 것을 즐깁니다
- 🤝 팀 협업과 코드 리뷰를 중요하게 생각합니다
...
<img src="https://img.shields.io/badge/TensorFlow-A2E1DB?style=flat-square&logo=TensorFlow&logoColor=white"/>
